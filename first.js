...
if (mode == "Light") {
    message = alert('Not Welcome to Javascript Session')
}
console.log(mode)
...
//Looping Statements Start
for (let i = 0; i <= 5; i++) {
    console.log(i)
}
console.log('Looping Statement End')
// ...existing code...

// Function to print odd numbers from 1 to a given limit
for (i = 1; i <= 5; i++) {
    if (i % 2 === 0) {
        console.log(i)
    }
}
// Call the function with a limit, for example, 10
// printOddNumbers(10);
...
let sum = i;
let n = 100;
// WAP print the odd numbers from 1 to 10
